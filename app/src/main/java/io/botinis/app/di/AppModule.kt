...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideUserProgressDao(database: BotinisDatabase) = database.userProgressDao()

    @Provides
    @Singleton
    fun provideSessionDao(database: BotinisDatabase) = database.sessionDao()
}
